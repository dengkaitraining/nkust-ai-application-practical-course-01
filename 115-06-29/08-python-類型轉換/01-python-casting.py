...
print(("x data type: " + str(type(x))), ("y data type: " + str(type(y))), ("z data type: " + str(type(z))))
...
print(("x data type: " + str(type(x))), ("y data type: " + str(type(y))), ("z data type: " + str(type(z))), ("w data type: " + str(type(w))))
